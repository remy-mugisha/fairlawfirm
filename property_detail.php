...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
     <?php
        ...
        $selectAllUsers = $db->prepare("SELECT * FROM manage_property  WHERE id = '".$_GET['id']."' ");
        $selectAllUsers->execute();
        if ($row = $selectAllUsers->fetch()) {
        ?> 
        <section class="page-header">
            <div class="page-header__bg" style="background-image: url(propertyMgt/propertyImg/<?php echo $row['image'];?>);"></div>
            <div class="container">
                        ...
                        <div class="blog-details">
                            <div class="blog-card__two">
                                <div class="blog-card__two__image">
                                    <img src="propertyMgt/propertyImg/<?php echo $row['image']?>" alt="firdip image" height="460px" width="100%">
                                </div>
