                        ...
                        <div class="blog-details">
                            <div class="blog-card__two">
                                <div class="blog-card__two__image">
                                    <img src="data/propertyMgt/propertyImg/<?php echo $row['image']?>" alt="Property Image" height="460px" width="100%">
                                </div>
                                <div class="blog-card-two__content">
                                    <ul class="list-unstyled blog-card-two__meta">
                                    </ul>
                                    <h3 class="blog-card-two__title">Description</h3>
                                    <p class="blog-card__two__text description-text"><?php echo $row['description']; ?></p>
                                </div>
                                <table class="table caption-top">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><p class="feature-one__item__text"><?php echo $row['price']; ?>&nbsp;Rwf</p></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <?php if ($row['property_type'] === "Commercial Building"): ?>
                                            <tr>
                                                ...
                                                <td><p class="feature-one__item__text"><?php echo $row['floor']; ?></p></td>
                                            </tr>
                                        <?php else: ?>
                                            <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><p class="feature-one__item__text"><?php echo $row['months']; ?> Months</p></td>
                                        </tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table><br>
                        ...
                        <div class="sidebar">
                            ...
                            <div class="container1">
                                ...
                                <form method="POST" action="bookingEmail.php">
                                    ...
                                    <div class="form-group">
                                        <select class="feature-one__item__text" id="months" name="months" required>
