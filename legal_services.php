                ...
                <div class="row gutter-y-30">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="feature-one__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='500ms'>
                            ...
                            <h4 class="feature-one__item__title"><?= __('Drafting of acts contracts')?></h4>
                            <p class="feature-one__item__text"><?= __('We draft specific civil and commercial contracts, without forgetting the memorandums of understanding.')?> </p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="feature-one__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='700ms'>
                            ...
                            <h4 class="feature-one__item__title"> <?= __('Mediation and Conciliation')?> </h4>
                            <p class="feature-one__item__text"><?= __('We take a more interventionist role in bringing the two parties together and in suggesting possible solutions to help achieve a settlement.')?></p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="feature-one__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='300ms'>
                            ...
                            <h4 class="feature-one__item__title"><?= __('Drafting of internal regulations and procedure manual')?></h4>
                            <p class="feature-one__item__text"><?= __('We help companies and communities to draft internal rules and regulations and procedure manual for good management of staff and financials.')?></p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="feature-one__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='300ms'>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="feature-one__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='300ms'>
                            ...
                            <h4 class="feature-one__item__title">Facilitator in movable and immovable sales transaction</h4>
                            <p class="feature-one__item__text">There are many variations of passages about of fre Lorem Ipsum avalable, but the </p>
                        </div>
                    </div>
                </div>
                 </div>
