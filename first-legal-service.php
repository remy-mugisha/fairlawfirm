...
<body class="custom-cursor">
        <section class="page-header">
            ...
            <div class="container">
                <h2 class="page-header__title">Legal Services Details</h2>
                ...
                <div class="row gutter-y-30">
                    <div class="col-md-12 col-lg-4">
                        ...
                        <div class="sidebar__single wow fadeInUp" data-wow-delay='300ms'>
                                    <h4 class="sidebar__title">Sub Categories</h4>
                                    <ul class="sidebar__categories list-unstyled">
                                        <li class="sidebar__categories__item"><a href="#"> <i class=""></i> fire service   ggggg jjjjj ddddgggg</a></li>
                                        <li class="sidebar__categories__item"><a href="#"> <i class=""></i> department</a></li>
                                        <li class="sidebar__categories__item"><a href="#"> <i class=""></i> Project</a></li>
                                        <li class="sidebar__categories__item"><a href="#"> <i class=""></i> ui/ux design</a></li>
                                        <li class="sidebar__categories__item"><a href="#"> <i class=""></i> Marketing</a></li>
                                    </ul>
                                </div>
                        </div>
                    </div>
                        ...
                        <div class="service-details__content">
                            <div class="service-details__single">
                                <div class="service-details__thumbnail wow fadeInUp" data-wow-delay='300ms'>
                                    <img src="assets/images/service/3-3-legal-services.jpg" alt="Fire Fighting">
                                </div>

                                <h3 class="service-details__title wow fadeInUp" data-wow-delay='300ms'>Business Law</h3>
                                ...
                                <h3 class="service-details__sub-title wow fadeInUp" data-wow-delay='300ms'>Nullamsed minon odio feugiat voluat sit amet</h3>
