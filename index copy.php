        ...
        <div class="container">
            ...
            <div class="row gutter-y-30" style="padding-bottom: 30px">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <a href="legal_services"><button type="submit" name="submit" style="color: white; font-size: 12px;padding: 10px 40px 10px 40px; margin-top:10px;"><?= __('Discover More Legal Services') ?>&nbsp;&nbsp;<i class="fa fa-arrow-right" aria-hidden="true"></i></button></a>
                </div>
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <a href="property_service"><button type="submit" name="submit" style="color: white; font-size: 12px;padding: 10px 40px 10px 40px; margin-top:10px;"><?= __('Discover More Property Services') ?>&nbsp;&nbsp;<i class="fa fa-arrow-right" aria-hidden="true"></i></button></a>
                </div>
            </div>
        </div>
    </section>
